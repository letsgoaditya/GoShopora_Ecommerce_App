    ...
    Scaffold(
        ...
        Column(
            ...
            SearchBar(
                ...
                onSearch = {/* need to add the logic */
            ...
            LazyRow(
                ...
                items(categories.size) { index ->
                    CategoryChip(
                        ...
                        isSelected = selectedCategory.value == categories[index].id,
                        onClick = {
                            selectedCategory.value = categories[index].id
                            navController.navigate(Screens.ProductList.createRoute(selectedCategory.value.toString()))
                        },
                    )
                }
            }
